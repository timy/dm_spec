...
- Call [`cdf_read( file_name, n_lines, sscanf_structure, ps )`](src/repr_generic.cc#L25,28)
- Define the callback funciton [`sscanf_structure`](src/repr_generic.cc#L31,40)

The callback functions `sscanf_st_energy` and `sscanf_st_dipole` show how energy and
