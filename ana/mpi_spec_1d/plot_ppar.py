...
file_idx = [0, 1, 2, 3]
#data_idx = ["Re[-1, 1, 1]z", "Re[ 1,-1, 1]z", "Re[ 1, 1,-1]z"]
#data_idx = ["Re[-1, 1, 1]z", "Re[ 1,-1, 1]z"]
data_idx = ["Re[ 0, 3, 0]z", "Im[ 0, 3, 0]z"]
#data_idx = ["Re[ 3, 0, 0]z"]
#data_idx = ["Re[ 1, 0, 0]z", "Re[ 0, 1, 0]z", "Re[ 0, 0, 1]z"]
#data_idx = ["Re[-2, 1, 0]z", "Re[ 0,-2, 1]z", "Re[-2, 0, 1]z"]
#data_idx = ["Re[-1, 0, 2]z", "Re[ 1, 0,-2]z"]
...
# t = data[:,0]
# my_data = data
# ax.plot(t, dat["Re[-1, 1, 1]z"]*dat["Re[-1, 1, 1]z"] + dat["Im[-1, 1, 1]z"]*dat["Im[-1, 1, 1]z"])
