...
void calc_ptot( std::complex<double> ***ptot, double** rho, struct parameters *ps,
                int ip, long ig );

void calc_ptot( std::complex<double> ***ptot, struct parameters *ps, long ig );

std::complex<double>*** prepare_pol_array( int dim, struct parameters *ps );
void clean_pol_array( int dim, std::complex<double> ***pol, struct parameters *ps );
